...
const getPackageName = (accessToken) => {
  ...
  return request(options)
    ...
    .catch(() => {
      exitWithMessage('Digital.ai Web App Protection 5.5.0 could not be downloaded. Make sure you have the "Product download" entitlement associated with the API key.');
    });
};
